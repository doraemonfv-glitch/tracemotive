...
frontend source tree to locate the assets. The Collector smoke remains the
existing loopback-only factory command from the root README; static serving is
deferred to V02-11.
